...
ConnetionConfig:                                                # By customizing the relevant configuration released by the ConnetionConfig connection, the memory usage can be optimized to a certain extent
  ...
  BufferSize: 64                                                # Reducing BufferSize can optimize memory usage, but it may cause CPU usage to rise。
Nodes:  
  -
    ApiConfig:
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/Xray/uk1.xx.com.crt                       # SSL CERT path 
        KeyFile: /etc/Xray/uk1.xx.com.key                        # SSL KEY PATH 
